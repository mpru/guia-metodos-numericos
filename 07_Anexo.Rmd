...
Si dentro de los corchetes se reemplaza $(p - x_0)$ por $- \frac{F(x_0)}{F'(x_0)}$ según la relación vista en \@ref(eq:relacion) y se despeja $p$, se obtiene una expresión para la primera aproximación $x_1$, dando lugar a la fórmula iterativa:
