...
### Empleo del punto fijo para la resolución de ecuaciones
...
de manera que la tarea de hallar un valor de $x$ que satisface \@ref(eq:a) es lo mismo que hallar un punto fijo de la función $f(x)$.
...
- Nota: para hacer representaciones gráficas de funciones con rapidez y sencillez pueden utilizar herramientas disponibles online. Por ejemplo, nos gusta mucho usar [Geogebra](https://www.geogebra.org/graphing?lang=en).
...
a. $f$ es una función continua en el intervalo $[a, b]$
b. $f(x) \in [a, b] \quad \forall x \in [a, b]$
c. $f'$ existe en $(a, b)$ con $|f'(x)| \le m < 1 \quad \forall x \in (a, b)$
