...
d <- tibble(x = seq(0, by = .5, length.out = 13), y = f(x))
...
ggsave("Plots/Unidad4_2_g.png", g, width = 4.5, height = 2.5)
...
ggsave("Plots/Unidad4_2_g1.png", g1, width = 4.5, height = 2.5)

g2 <- g1 + 
    stat_function(fun = recta2pts(d$x[1], d$y[1], d$x[2], d$y[2]),
                  aes(color = "Recta de\n interpolaci?n"))  # recta que pasa por x0 y x1
ggsave("Plots/Unidad4_2_g2.png", g2, width = 4.5, height = 2.5)   
...
g3 <- g +
    ...
    stat_function(fun = recta2pts(d$x[2], d$y[2], d$x[3], d$y[3]),
                  aes(color = "Recta de\n interpolaci?n")) 
ggsave("Plots/Unidad4_2_g3.png", g3, width = 4.5, height = 2.5)  
...
g4
ggsave("Plots/Unidad4_2_g4.png", g4, width = 4.5, height = 2.5)  
...
ggsave("Plots/Unidad4_2_g5.png", g5, width = 4.5, height = 2.5)   
...
g6 <- g +
    ...
    stat_function(fun = as.function(poly.calc(d$x[3:5], d$y[3:5])),
                  aes(color = "Polinomio de\n interpolaci?n"))  
ggsave("Plots/Unidad4_2_g6.png", g6, width = 4.5, height = 2.5)   
...
ggsave("Plots/Unidad4_2_g7.png", g7, width = 4.5, height = 2.5)
...
g8 <- g +
    ...
    stat_function(fun = as.function(poly.calc(d$x[1:4], d$y[1:4])),
                  aes(color = "Polinomio de\n interpolaci?n"))  
ggsave("Plots/Unidad4_2_g8.png", g8, width = 4.5, height = 2.5)   
...
g9 <- g +
    ...
    stat_function(fun = as.function(poly.calc(d$x[4:7], d$y[4:7])),
                  aes(color = "Polinomio de\n interpolaci?n"))  
ggsave("Plots/Unidad4_2_g9.png", g9, width = 4.5, height = 2.5)   
...
ggsave("Plots/Unidad4_2_g10.png", g10, width = 4.5, height = 2.5)
